...
-- Create the table
CREATE TABLE SexGender (
    SexGender VARCHAR(20)
);

-- Insert test data
INSERT INTO SexGender (SexGender) VALUES
('Male'),
('Female'),
('Non-binary'),
('Transgender'),
...
-- Insert test data
INSERT INTO MaritalStatus (MaritalStatus) VALUES
('Single'),
('Married'),
('Divorced'),
('Widowed'),
...
-- Insert test data
INSERT INTO PreferredContact (PreferredContact) VALUES
('Email'),
('Phone Call'),
('SMS / Text Message'),
('WhatsApp'),
...
-- Drop table if exists (optional for re-creation)
DROP TABLE IF EXISTS PreferredPaymentMethod;

-- Create the table with larger column size
CREATE TABLE PreferredPaymentMethod (
    PreferredPaymentMethod VARCHAR(100)  -- increased from 30
);

-- Insert test data again
INSERT INTO PreferredPaymentMethod (PreferredPaymentMethod) VALUES
('Cash'),
('Credit Card'),
('Debit Card'),
('Bank Transfer'),
